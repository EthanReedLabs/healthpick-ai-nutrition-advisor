...
2. 使用空白健康档案依次输入“我想减重”“我在健身”“我血糖有点高”，展示三类诉求识别、未落档结构化候选和 A/B 引用。
3. 编辑档案，选择减脂、45–64 岁并填写 45 岁，生成轻盈减脂主方案；展示推荐原因、行动、替换和 A/B 页码。
4. 输入“我尿酸高，也想减重”或增加海鲜过敏，证明不适宜食材硬过滤、个体化目标关闭、安全替换和两条指定专业提示。
...
- [x] RC10-01～RC10-07 全部有通过记录，`RC10-FINAL` 为 passed，开放阻断为 0。
...
- 如何处理疾病：不诊断、不治疗、不调药；高风险关闭个体化目标，只展示已过滤的通用安全替换，并同时显示医疗免责声明和“建议您在使用本方案前咨询专业医师或注册营养师”。
