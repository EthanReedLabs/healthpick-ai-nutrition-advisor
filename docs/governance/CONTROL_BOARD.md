...
- 最终验收就绪度：`NOT_READY`
- 当前阶段：`PHASE-08`
- 最近审计：`2026-08-22T20:01:37.810593+08:00`
...
| PHASE-02 | 知识数据生产化 | `passed` | docs/evidence/phase-02-baseline-record.md |
| PHASE-03 | 最薄动态问答闭环 | `passed` | docs/evidence/phase-03-baseline-record.md |
| PHASE-04 | 推荐与医疗安全 | `passed` | docs/evidence/phase-04-baseline-record.md |
...
| PHASE-02 | DATA-03 | 生成 A/B 结构化事实 | KNOWLEDGE | `passed` | control/records/DATA-03.yaml |
| PHASE-02 | DATA-04 | 生成 C 平台事实并隔离 | KNOWLEDGE | `passed` | control/records/DATA-04.yaml |
| PHASE-02 | DATA-05 | 建立知识 Schema 与 migration | API | `passed` | control/records/DATA-05.yaml |
| PHASE-02 | DATA-06 | 执行导入与隔离 smoke | API/QA_DOCS | `passed` | control/records/DATA-06.yaml |
...
| PHASE-03 | P03-03 | A/B/C 路由与检索适配 | API/KNOWLEDGE | `passed` | control/records/P03-03.yaml |
| PHASE-03 | P03-04 | 引用生成与证据校验 | API | `passed` | control/records/P03-04.yaml |
| PHASE-03 | P03-05 | 会话与 SSE Chat API | API | `passed` | control/records/P03-05.yaml |
| PHASE-03 | P03-06 | Next.js 聊天与引用界面骨架 | WEB | `passed` | control/records/P03-06.yaml |
| PHASE-03 | P03-07 | 浏览器动态问答最薄闭环 | WEB/API/QA_DOCS | `passed` | control/records/P03-07.yaml |
| PHASE-03 | P03-08 | Phase 03 退出验收 | LEAD | `passed` | control/records/P03-08.yaml |
...
| PHASE-04 | P04-07 | Phase 04 退出验收 | LEAD | `passed` | control/records/P04-07.yaml |
...
| PHASE-05 | P05-05 | 全部 P0 追踪矩阵与回归闭环 | QA_DOCS | `passed` | control/records/P05-05.yaml |
| PHASE-05 | P05-06 | Phase 05 退出验收 | LEAD | `passed` | control/records/P05-06.yaml |
...
| PHASE-06 | P06-05 | Phase 06 退出验收 | LEAD | `passed` | control/records/P06-05.yaml |
| PHASE-07 | P07-01 | 构建完整黄金安全串库评测集 | QA_DOCS/KNOWLEDGE | `passed` | control/records/P07-01.yaml |
| PHASE-07 | P07-02 | 运行评测并达到冻结阈值 | QA_DOCS | `passed` | control/records/P07-02.yaml |
...
| PHASE-07 | P07-06 | 功能冻结与 Phase 07 验收 | LEAD | `passed` | control/records/P07-06.yaml |
